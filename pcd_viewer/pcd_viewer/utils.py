...
def PlaneRegression(points, threshold, init_n, iter):
    ...
    Args:
        ...
        threshold (float, optional): distance threshold. Defaults to 0.003.   0.01,
...
def SaveResult(points, colors,file):
    path = './static/pcd_data_seg/'
    pcd = o3d.geometry.PointCloud()
    pcd.points = o3d.utility.Vector3dVector(points)
    pcd.colors = o3d.utility.Vector3dVector(colors)
    o3d.io.write_point_cloud(path+file,pcd)
    print(path+file)
